...
// General Google Page enhancements
	...
	/* CONDITIONAL-EVALUATION related to Homepage Special Logo [exception for g.Images-homepage] */
	   ((($('logo') && $('logo').alt == 'Google') || location.href.indexOf('images.google.') > -1) ? 
		/* insert logo img */	"BODY[vlink='#551a8b'] > DIV#xjsd, BODY > SPAN#main > CENTER > DIV#xjsd   {width:150px !important; height:55px !important; background:transparent url('" + googleLogoBLACK + "') no-repeat scroll 0% !important; font-size:0;}" +
		/* intl logo mover */	"BODY[vlink='#551a8b'] > DIV#xjsd, BODY > SPAN#main > CENTER > DIV#xjsd   {position:absolute; top:100px; left:0; width:100% !important; background-position:center !important;}" 
					: "") +
	   (($('logo') && $('logo').alt != 'Google' && location.href.indexOf('images.google.') == -1) ? 
					"" : 
...
// Google Search Results Page enhancements
	...
	/* r-side ads */		"#rhscol, #mbEnd   {display:none;}" +
...
// Maps enhancements
	/* logo img */			"IMG[alt='Go to Google Maps Home'], BODY > DIV#header > DIV#search > FORM#q_form > DIV#logo IMG   {display:none;}" +
	...
	/* headers */			"TABLE#titlebar, DIV#pp-maincol DIV.bar, DIV#pp-sidecol DIV.bar   {border:0; background-color:#333; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
	...
	/* place loc action bar */	"DIV#pp-headline-details DIV.actbar   {background-color:#000 !important;}" +
...
// Docs enhancements
	...
	/* templates header */		"DIV#templates-header > DIV#templates-header-location   {background-color:#333 !important; border:0 none !important; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
	/* templates header tabs */	"DIV#templates-header > DIV#templates-header-tabs   {border:0 none; background-color:#000;}" +
	/* templates header tab sel */	"DIV#templates-header > DIV#templates-header-tabs .templates-list-selected   {margin-bottom:1em; border:0 none; background-color:#000; font-weight:bold; color:#fff;}" +
	/* settings outer box */	"FORM.settings-container-form > TABLE.roundedblock   {-moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
	/* settings corner imgs */	"FORM.settings-container-form > TABLE.roundedblock TD   {background-image:none;}" +
	/* footers */			"BODY > DIV.footer   {display:none;}" +
...
// Books enhancements
	/* logo img */			"BODY > DIV > CENTER > TABLE#top_search_box > TBODY > TR > TD[style='padding-bottom: 8px; padding-top: 2px;'] > A > IMG[height='40'], BODY[bgcolor='#ffffff'] > TABLE > TBODY > TR > TD[valign='top'][rowspan='2'] > A > IMG   {display:none;}" +
	/* announcement */		"BODY > DIV > CENTER > SPAN.announcement   {color:#999;}" +
	/* headers */			"BODY > DIV > CENTER > TABLE#hp_table > TBODY > TR > TD > DIV.sbr > DIV.sub_cat_section > DIV.sub_cat_title, BODY > DIV > CENTER > TABLE#hp_table > TBODY > TR > TD DIV.hpm_title, BODY > DIV#results_bar   {background-color:#333 !important; border:0 none !important; font-weight:bold; color:#000 !important; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
	...
	/* right-side ads */		"DIV#rhswrapper > TABLE#rhssection > TBODY > TR > TD   {display:none;}" +
...
// Blogs enhancements
	...
	/* headers */			"BODY > DIV#canvas > DIV.heading, DIV#rightHandContainer DIV.heading, BODY TABLE.ttt, BODY TABLE.ttt TD   {padding-left:0.7em; background-color:#333; border:0 none !important; color:#ccc!important; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
	...
	/* footer */			"BODY > CENTER > CENTER > FONT[size='-2']:last-child, BODY > DIV#f > CENTER:last-child > FONT[size='-2']   {display:none;}" +
...
// Notebook enhancements
	...
	/* left menu C-footer */	"BODY.e > DIV.h > TABLE.p > TBODY > TR[valign='top'] > TD[align='left'] > DIV.jc > DIV.bf   {display:none;}" +
	/* labels block header */	"BODY.e > DIV.h > TABLE.p > TBODY > TR > TD > DIV.jc > DIV.rc > DIV[class='sc rb']   {-moz-border-radius-topright:14px; -moz-border-radius-topleft:14px;}" +
	/* labels lower block */	"BODY.e > DIV.h > TABLE.p > TBODY > TR > TD > DIV.jc > DIV.rc > DIV[class='wc sb']   {border-bottom:2px solid #b5edbc; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
	/* tip bar */			"BODY.e TD.cb > SPAN.eb   {-moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
...
// Translate enhancements
	/* logo img */			"BODY > DIV#whole > TABLE[cellspacing='0'][cellpadding='0'][border='0'][style='font-size: medium;'] > TBODY > TR > TD[width='1%'][height='40'] > A > IMG, BODY > TABLE[cellspacing='0'][cellpadding='0'][border='0'][style='font-size: medium;'] > TBODY > TR > TD[width='1%'][height='40'] > A > IMG, BODY > DIV#whole > DIV[style='margin: 10px 0pt 5px;'] > A > IMG[height='40'], BODY[marginheight='3'][topmargin='3'] > DIV[style='margin: 10px 0pt 5px;'] > A > IMG[height='40']   {display:none;}" +
	...
	/* boxes */			"BODY > DIV#whole > DIV#main >  DIV#alang, BODY[marginheight='3'][topmargin='3'] > DIV.section > TABLE > TBODY > TR > TD.main, BODY[marginheight='3'][topmargin='3'] > DIV.section > DIV#toolbar_float, BODY > DIV#content > DIV.section > TABLE > TBODY > TR > TD.main   {padding-top:0.7em; padding-bottom:0.5em; background-color:#191919; border:0 none; color:#ccc !important;padding-left:1em; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
	/* footer */			"BODY > DIV#whole > DIV#foot, BODY > DIV#whole > DIV.footer, BODY DIV.tab_footer, BODY > DIV.tab_footer   {display:none;}" +
...
// Profile enhancements
	...
	/* search logo img [insert] */	"BODY.ll_page_body > DIV > DIV.profile-results-header-search > FORM[name='profilesearch']   {padding:0px 0 17px 150px; background:transparent url('" + googleLogoBLACK + "') no-repeat scroll 0% !important;}" +
	/* search header */		"BODY.ll_page_body > DIV > TABLE.profile-results-header-ribbon   {border:0 none; background-color:#333 !important; color:#fff; padding-left:0.7em;-moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}" +
...
// BRUTE-FORCE for "less cooperative" sites (each URI validated)
	...
	function gBFenh() {
		...
		/* submit button */	sIR("INPUT[type='submit'], INPUT[type='button'], .yt-button-primary   {background:#333 none !important; border:solid 1px #ccc !important; -moz-border-radius-topright:14px !important; -moz-border-radius-topleft:14px !important; -moz-border-radius-bottomright:14px !important; -moz-border-radius-bottomleft:14px !important; color:#fff !important; cursor:pointer;}");
	...
	if (location.href.indexOf('.google.') > -1 && location.href.indexOf('/advanced_search?') > -1) {
		...
		/* logo img [hide] */	sIR("BODY > TABLE[width='100%'][style='margin-top: 1em;'] > TBODY > TR:first-child > TD[width='1%']:first-child > A > IMG[width='150']   {display:none;}");
		...
		/* header bar L */	sIR("BODY > TABLE[width='100%'][style='margin-top: 1em;'] > TBODY > TR:first-child > TD > TABLE[width='100%'][style='border-top: 1px solid rgb(51, 102, 204);'] > TBODY > TR > TD.page-title   {padding-left:0.1em; background-color:#333 !important; color:#fff !important; -moz-border-radius-topleft:9px; -moz-border-radius-bottomleft:14px;}");
		/* header bar R */	sIR("BODY > TABLE[width='100%'][style='margin-top: 1em;'] > TBODY > TR:first-child > TD > TABLE[width='100%'][style='border-top: 1px solid rgb(51, 102, 204);'] > TBODY > TR > TD[bgcolor='#d5ddf3']   {padding-right:0.2em; background-color:#333; -moz-border-radius-topright:9px; -moz-border-radius-bottomright:14px;}");
		/* top box */		sIR("DIV.outer-box > FORM.block   {border-color:#333; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		/* top box title */	sIR("DIV.outer-box > DIV:first-child, DIV.outer-box > DIV:first-child > DIV   {border-color:#333; background-color:#333 !important; font-weight:bold; color:#fff !important; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px;}");
		/* lower box */		sIR("DIV#related.block   {border-color:#333; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		...
		/* top box bg */	sIR("TABLE[width='99%'] > TBODY > TR[bgcolor='#cbdced'] > TD TABLE[width='100%'] > TBODY > TR[bgcolor='#cbdced'], TABLE[width='99%'] > TBODY > TR[bgcolor='#cbdced'] > TD > TABLE[width='100%'] > TBODY > TR[bgcolor='#cbdced'] TD, BODY > FORM[name='f'] > FONT > TABLE > TBODY > TR:first-child > TD:first-child   {padding-left:0.5em; background-color:#222 !important; color:#ccc !important;}");
		/* footer */		sIR("BODY > FORM[name='f'] > CENTER > FONT[face='arial,sans-serif'] > FONT[size='-1'], BODY > CENTER > FONT[size='-1']      {display:none;}");
	}
	...
	if (location.href.indexOf('news.google.') > -1 && (location.href.indexOf('/news') > -1 || location.href.indexOf('/image?') > -1 || location.href.indexOf('/advanced_news_search') > -1)) {
		...
		/* edit page panel */	sIR("#personalize-open   {border:0 none; background-color:#222; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		/* R-side ads */	sIR("TABLE.left > TBODY > TR > TD#table-spacer-cell, TABLE.left > TBODY > TR > TD.right-nav   {display:none;}");
	...
	if (location.href.indexOf('images.google.') > -1 && location.href.indexOf('/advanced_image_search') > -1) {
		...
		/* logo img [insert] */	sIR("BODY > FORM > TABLE > TBODY > TR > TD[width='1%'][rowspan='2']   {width:150px !important; height:55px !important; background:transparent url('" + googleLogoBLACK + "') no-repeat scroll 0% !important; font-size:0;}");
		...
		/* header L */		sIR("BODY > FORM > TABLE[width='99%'] > TBODY > TR > TD[rowspan='2'] > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#d5ddf3']:first-child   {background-color:#333; -moz-border-radius-topleft:14px; -moz-border-radius-bottomleft:14px;}");
		/* header R */		sIR("BODY > FORM > TABLE[width='99%'] > TBODY > TR > TD[rowspan='2'] > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#d5ddf3'][align='right']   {background-color:#333; -moz-border-radius-topright:14px; -moz-border-radius-bottomright:14px;}");
	...
	// Videos: Report Problem Popup
	if (location.href.indexOf('video.google.') > -1 && location.href.indexOf('/reportproblem?') > -1) {
		/* Global BF Styles */	gBFenh();

		/* Report table bg */	sIR("BODY > TABLE.background, BODY > TABLE.background TABLE.content   {background-color:#000;}");
	}
	...
	// Docs enhancements
	if (location.href.indexOf('//docs.google.') > -1) {
		/* Global BF Styles */	gBFenh();
		...
		/* doc logo [insert] */	sIR("BODY#editPage > TABLE#encloser > TBODY > TR#navigation > TD > TABLE[width='100%'] > TBODY > TR[style='height: 40px;'] > TD[style='padding-left: 2px;']   {width:150px !important; height:55px !important; background:transparent url('" + googleLogoBLACK + "') no-repeat scroll 0% !important; font-size:0;}");
	...
	if (location.href.indexOf('//translate.google.') > -1 && location.href.indexOf('/translate_n?') > -1) {
		...
		/* logo img [insert] */	sIR("BODY > DIV[style='padding: 8px; white-space: nowrap;'], BODY > DIV[style='padding: 6px 8px; white-space: nowrap;']   {padding-left:160px !important; Xwidth:150px !important; height:55px !important; background:transparent url('" + googleLogoBLACK + "') no-repeat scroll top left !important; font-size:0;}");
	...
	if (location.href.indexOf('.google.') > -1 && location.href.indexOf('/profiles/') > -1) {
		/* Global BF Styles */	gBFenh();

		/* logo img [hide] */	sIR("BODY > DIV.g-doc-800 > DIV.g-tpl-160 > DIV.g-first > A > IMG.logo   {display:none;}");
		/* logo img [insert] */	sIR("BODY > DIV.g-doc-800 > DIV.g-tpl-160 > DIV.g-first   {width:150px !important; height:55px !important; background:transparent url('" + googleLogoBLACK + "') no-repeat scroll 0% !important; font-size:0;}");
		...
		/* footer */		sIR("BODY > DIV.g-doc-800 DIV.footer   {display:none;}");
	}
	...
	if (location.href.indexOf('books.google.') > -1 && (location.href.indexOf('/advanced_book_search') > -1 || location.href.indexOf('/agreement/') > -1)) {
		...
		/* header L */		sIR("BODY > FORM[action='/books'] > TABLE > TBODY > TR > TD[rowspan='2'] > TABLE TD:first-child   {border:0 none; background-color:#333; color:#fff !important; -moz-border-radius-topright:14px; -moz-border-radius-bottomright:14px;-moz-border-radius-topleft:14px; -moz-border-radius-bottomleft:14px;}");
		...
		/* footers */		sIR("BODY > FORM[action='/books'] > CENTER > FONT[face='arial,sans-serif'] > FONT[size='-1'], BODY > DIV.g-section > DIV.g-unit > DIV.footer, BODY > DIV.g-doc > DIV.g-section > DIV.g-unit > DIV.footer, BODY > FORM[name='f'] > CENTER:last-child > FONT[size='-1']   {display:none;}");
	}
	...
	if (location.href.indexOf('.google.') > -1 && location.href.indexOf('/trends') > -1) {
		...
		/* logo img [insert] */	sIR("BODY > CENTER > TABLE[cellspacing='0'][cellpadding='0'][border='0'] > TBODY > TR:first-child > TD[align='left'], BODY.product > H1, BODY > FORM[name='search'] > TABLE > TBODY > TR > TD[width='1'][rowspan='2']   {padding-top:70px; width:150px; height:55px; background:transparent url('" + googleLogoBLACK + "') no-repeat scroll top center !important; font-size:0;}");
		/* logo tbl adjust */	sIR("BODY > CENTER > TABLE[cellspacing='0'][cellpadding='0'][border='0']   {position:relative; top:-70px;}");
	...
	if (location.href.indexOf('.googlelabs.') > -1 || location.href.indexOf('//labs.google.') > -1) {
		...
		/* logo img [insert] */	sIR("BODY > DIV#g-hdr > FORM > TABLE#g-hdr-table > TBODY > TR > TD#g-hdr-logo-col, BODY > DIV[style='margin: 3px 5px;'] > TABLE#controls > TBODY > TR:first-child > TD[valign='top']:first-child   {width:150px; height:55px; background:transparent url('" + googleLogoBLACK + "') no-repeat scroll top center !important; font-size:0;}");
		...
		/* headers */		sIR("H3, BODY > H2, DIV#main-with-sidebar H4, .tabs, #info1, #info2   {padding-left:0.7em; background-color:#333; border:0; color:#fff; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		...
		/* tip panel */		sIR(".tip, .tip .heading   {background-color:#222; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		/* L-side slider */	sIR("TABLE#sbc   {background-color:#333;}");
		/* share panel bg */	sIR(".share   {padding:7px 7px 0 7px; background-color:#222; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		/* share btn */		sIR(".share .button   {border:0 none !important; background-color:#000 !important; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		/* share dropdown */	sIR(".share .dd   {padding:7px; border:0 none; background-color:#181818; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		/* footer */		sIR("BODY > DIV > DIV#footer   {display:none;}");
	}
	...
	if (location.href.indexOf('code.google.') > -1 || location.href.indexOf('.googlecode.') > -1) {
		...
		/* top menu tabs */	sIR("BODY > TABLE#mt > TBODY > TR:first-child > TH > DIV.tab   {-moz-border-radius-topright:14px; -moz-border-radius-topleft:14px;}");
		/* top menu submenuR */	sIR("BODY > TABLE.st   {-moz-border-radius-topright:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:6px;}");
		/* top menu submenuL */	sIR("BODY > TABLE.st > TBODY > TR > TD:first-child DIV.isf   {-moz-border-radius-bottomleft:6px;}");
		...
		/* headers */		sIR("DIV#gc-topnav, DIV#searchControl > DIV > DIV.gsc-tabsArea, DIV#maincol DIV#nav_and_rev, DIV#maincol > DIV.bubble_bg, TABLE#cue > TBODY > TR > TD[style='border-top: 1px solid rgb(204, 204, 204); border-bottom: 1px solid rgb(255, 255, 255); background: rgb(221, 248, 204) none repeat scroll 0%; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial;']   {background-color:#333 !important; border:0 none !important; color:#fff; padding-right:0.5em; padding-left:0.5em; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
		...
		/* side blocks */	sIR("DIV#maincol DIV.pmeta_bubble_bg, DIV#maincol DIV[style='background: rgb(221, 248, 204) none repeat scroll 0%; -moz-background-clip: -moz-initial; -moz-background-origin: -moz-initial; -moz-background-inline-policy: -moz-initial; margin-bottom: 5px; table-layout: fixed;'], DIV#whb.tip   {margin-top:0.5em; background-color:#333 !important; border:0 none !important; -moz-border-radius-topright:14px; -moz-border-radius-topleft:14px; -moz-border-radius-bottomright:14px; -moz-border-radius-bottomleft:14px;}");
	...
	// Toolbar enhancements
	if ((location.href.indexOf('tools.google.') > -1 && location.href.indexOf('/firefox/toolbar/') > -1) || (location.href.indexOf('.google.') > -1 && location.href.indexOf('/toolbar/ff/') > -1)) {
		/* Global BF Styles */	gBFenh();

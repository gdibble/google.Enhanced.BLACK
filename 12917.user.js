...
// General Google Page
	...
	/* intl home logo [insert] */	"BODY > SPAN#main > CENTER > SPAN#body > CENTER > DIV#logo,DIV#lga,DIV#lga > DIV#logo {width:281px !important; height:131px !important; background:transparent url('"+gHpL+"') no-repeat scroll top center !important;}"+

	/* CONDITIONAL-EVALUATION related to Homepage Special Logo [exception for g.Images-home] */
	   (((($('logo')&&($('logo').alt=='Google')||iO(lH,"images.google.")>-1))&&$("lga")==null) ? 
	   ...
	   (($('logo')&&$('logo').alt!='Google'&&iO(lH,"images.google.")==-1) ? 
		...
		/* h.spcl logo hider */	(uHideLogos?"BODY > SPAN#main > CENTER > SPAN#body > CENTER > A > IMG#logo {visibility:hidden;}":"")+
...
// iGoogle Homepage
	...
	/* alert / promo box */		"DIV#undel_box,.header_promo,#promo_text,.promo_ag {padding-left:0.4em; background-color:#171717; border:0 none !important; "+bS('radiusAll')+":14px; color:#ff0 !important;}"+
...
function configureScript(e){
	...
	function createLayers(){
		...
		sIR("#gsdialogLayer LI {margin:15px 0px 7px; font-family:Trebuchet MS,Verdana; font-style:italic; color:#fff;}");

...
// General Google Page
	...
	/* google bar b-line */		"#gbh,.gbh {border-color:#555;}"+
	/* google bar bg */		"#guser,#guser *,#gbar,#gbar *,#ghead,#gog,.lhcl_onebar,.lhshdr,.rshdr,.tpblk,.tphdr,#tbbcc,#rgsh_s,#gc-header {background-color:transparent !important; font-family:"+uFontFamily+" !important; color:#ccc;}"+
	...
	/* intl home logo [insert] */	"BODY > SPAN#main > CENTER > SPAN#body > CENTER > DIV#logo,DIV#lga,DIV#lga > DIV#logo,DIV#lga > DIV > DIV#logo {width:281px !important; height:191px !important; background:transparent url('"+gHpL+"') no-repeat scroll center center !important;}"+
	/* intl home logo [remove] */	"DIV#lga > DIV > DIV#logo {background-image:none !important;}"+

	/* CONDITIONAL-EVALUATION related to Homepage Special Logo [exception for g.Images-home] */
	   (((($('logo')&&($('logo').alt=='Google'||$('logo').title=='Google')||iO(lH,"images.google.")>-1))&&$("lga")==null) ? 
	...
	/* srch input b-brdr */		"FORM[name='f'] TABLE#search-input > TBODY > TR > TD.srchBoxCont {border-bottom:0 none transparent;}"+
	...
	/* btn bgs */			".lsbb,DIV.q-outer,DIV.q-inner,.srchButtonRightShadow,.srchButtonBorder {background-color:transparent !important; border:0 none !important;}"+
	/* srch btn spacing */		"DIV.skunk-head > DIV.cntrl > TABLE.cntrltable > TBODY > TR > TD > DIV.q-outer > DIV.q-inner > INPUT#q-sub,INPUT#srchButton {margin-left:0.5em !important;}"+
	/* srch box brdrs */		".tsf-p TABLE,.tsf-p TD,.ds {border:0 none !important;}"+
...
// Google Search Results Page
	/* logo img [remove] */		"BODY#gsr > DIV#header > FORM#tsf > TABLE#sft > TBODY > TR > TD > H1 > A#logo > IMG,BODY > SPAN#main > DIV#header > DIV#sform > FORM#tsf > TABLE#sft > TBODY > TR > TD:first-child > H1 > A#logo > IMG,BODY > SPAN#main > DIV DIV#sform > FORM#tsf > TABLE#sft > TBODY > TR[valign='top'] > TD[style='padding-right: 8px;'] > H1 > A#logo > IMG,BODY#gsr > DIV#cnt > FORM#tsf > TABLE#sft > TBODY > TR[valign='top']:first-child > TD:first-child > H1 > A#logo > IMG,BODY > SPAN#main > DIV >  DIV#cnt > DIV#sform > FORM#tsf > TABLE#sft > TBODY > TR[valign='top']:first-child > TD:first-child > H1 > A#logo > IMG,DIV#cnt DIV#sfcnt FORM#tsf > DIV > DIV > H1 > A#logo > IMG,DIV#cnt > DIV#sfcnt > FORM#tsf > DIV > DIV > A > IMG[style='padding-top: 10px;'],FORM#tsf > DIV > DIV#logocont > H1 > A#logo > IMG[width='178'] {display:none;}"+
...
// News Results
	...
	/* header search btn bg */	".ds1,.ds2,.ds3,.lsbb1,.lsbb2,.lsbb3 {background-color:#000; border:0 none;}"+
...
// Maps
	...
	/* L-panel bg */		"#page > #panel {background-color:transparent;}"+
	...
	/* place loc dropdown */	"#resultspanel .dropdown {background-color:#222; "+bS('radiusAll')+":14px;}"+
...
// Product Search / Shopping
	/* logo img */			"A#glogo > IMG[width='150'][height='105'],CENTER > H1#ps-logo > IMG,BODY > FORM[name='f'] > TABLE[width='100%'][cellspacing='0'][cellpadding='0'][border='0'][style='clear: left;'] > TBODY > TR > TD:first-child > A#glogo > IMG,BODY > DIV#hp-cont > H1#hp-logo > IMG,BODY > DIV#srp-header > FORM[name='f'] > TABLE:first-child > TBODY > TR > TD:first-child > A#glogo > IMG,BODY > FORM > DIV#advd-search-header > TABLE:first-child > TBODY > TR > TD[width='1%']:first-child > A#advd-logo > IMG,BODY DIV#srp-header > FORM[name='f'] > TABLE > TBODY > TR > TD > A#srp-logo > IMG,BODY DIV#srp-header > FORM[name='f'] > TABLE > TBODY > TR > TD > A#srp-logo > IMG,BODY > DIV#srp-header > FORM[name='f'],BODY DIV#hp-cont > H1#hp-logo > IMG {display:none;}"+
	/* Home logo img [insert] */	"BODY > DIV#hp-cont > H1#hp-logo,BODY > DIV#srp-header > FORM[name='f'],BODY DIV#hp-cont > H1#hp-logo {height:131px !important; margin-top:25px; margin-bottom:0; background:transparent url('"+gHpL+"') no-repeat scroll center !important;}"+
...
// Groups
	...
	/* search header options */	"BODY > TABLE#sft DIV.ss {color:#777 !important;}"+
...
// Scholar
	/* logo imgs [remove] */	"BODY > FORM[name='f'] > TABLE[width='99%'] > TBODY > TR:first-child > TD[width='1%'] > A > IMG,BODY > FORM[name='prefform'] > CENTER > TABLE[width='100%'] > TBODY > TR:first-child > TD:first-child > A > IMG[height='40'],BODY > TABLE[style='margin: 7px 3px; clear: both;'] > TBODY > TR:first-child > TD:first-child > A > IMG[height='40'],BODY > FORM[name='gs'] > TABLE#scife_hdr > TBODY > TR:first-child > TD[valign='top']:first-child > A > IMG {display:none;}"+
...
// Translate
	...
	/* boxes */			"BODY > DIV#whole > DIV#main >  DIV#alang,BODY[marginheight='3'][topmargin='3'] > DIV.section > TABLE > TBODY > TR > TD.main,BODY[marginheight='3'][topmargin='3'] > DIV.section > DIV#toolbar_float,BODY > DIV#content > DIV.section > TABLE > TBODY > TR > TD.main {padding-top:0.7em; padding-bottom:0.5em; background-color:#191919; border:0 none; color:#ccc !important;padding-left:1em; "+bS('radiusAll')+":14px;}"+
...
// BRUTE-FORCE for "less cooperative" sites (each URI validated)
	...
	function Ge(){
		...
		/* google bar bg */	sIR("#guser,#guser *,#gbar,#gbar *,#ghead,#gog,.lhcl_onebar,.lhshdr,.rshdr,.tpblk,.tphdr,#tbbcc,#rgsh_s,#gc-header {background-color:transparent !important; font-family:"+uFontFamily+" !important; color:#ccc;}");
		...
		/* google bar b-line */	sIR("#gbh,.gbh {border-color:#555;}");
		/* search input */	sIR("INPUT[type='text'],INPUT[type='password'],INPUT[name='q'] {background:#333 none !important; background-color:rgba(0,0,0,0.6) !important; color:#ff0; padding:2px; border:solid 1px #ccc; font-weight:bold; color:"+uColorInputTxt+" !important;}");
		...
		/* btn bgs */		sIR(".lsbb,DIV.q-outer,DIV.q-inner,.srchButtonRightShadow,.srchButtonBorder {background-color:transparent !important; border:0 none !important;}");
		/* srch btn spacing */	sIR("DIV.skunk-head > DIV.cntrl > TABLE.cntrltable > TBODY > TR > TD > DIV.q-outer > DIV.q-inner > INPUT#q-sub,INPUT#srchButton {margin-left:0.5em !important;}");
		/* srch box brdrs */	sIR(".tsf-p TABLE,.tsf-p TD,.ds {border:0 none !important;}");
		...
		/* search suggest bx */	sIR(".ac-renderer,.ac-renderer DIV,.gac_id,.gac_m {background-color:#333 !important; color:#999 !important;}");
		/* search suggest hv */	sIR(".gac_b TD {background-color:#555 !important; color:#fff !important;}");
...
//,BODY > TABLE[width='95%'] > TBODY > TR:first-child > TD[width='1%']:first-child > IMG
	// Google Login Pages
	if((iO(lH,".google.")>-1&&(iO(lH,"/Login?")>-1||iO(lH,"/ServiceLogin?")>-1)||iO(lH,"/ServiceLoginAuth")>-1||iO(lH,"/accounts/Login")>-1)||(iO(lH,"https%3A%2F%2Fwww.google.com%2Fvoice%2Faccount%2Fsignin%2F")>-1)){
		/* applyGlobals */	Ge();
		...
		/* logo img [insert] */	sIR("BODY[onload='gaia_setFocus();'] > DIV#main > DIV.header,BODY[onload='gaia_setFocus();'].compact > H1,BODY > DIV#main > DIV.header,BODY > TABLE[width='95%']:first-child > TBODY > TR[valign='top'] > TD[width='1%']:first-child,BODY > DIV#main > DIV > DIV.logo,BODY > DIV#main > TABLE[width='100%'][cellpadding='2'] > TBODY > TR > TD[width='150'][style='padding-right: 10px;'][rowspan='2'],BODY > DIV#header > DIV#logo,BODY > DIV#main > DIV.logo-header,BODY > TABLE[width='95%'] > TBODY > TR:first-child > TD[width='1%']:first-child {width:150px !important; height:55px !important; border:0 none; background:transparent url('"+gL+"') no-repeat scroll 0 !important; font-size:0;}");
	...
	// .ORG
	else if(iO(lH,".google.org/")>-1){
		/* applyGlobals */	Ge();

		/* body bg */		sIR("BODY > DIV#container {background-color:#000;}");
		/* logo img [remove] */	sIR("BODY > DIV#container > TABLE#layout > TBODY > TR:first-child > TD#header > DIV > DIV.divider > A > IMG,BODY > DIV#container > TABLE#layout > TBODY > TR:first-child > TD#header > DIV > DIV.divider > TABLE > TBODY > TR:first-child > TD:first-child > A > IMG {display:none;}");
		/* logo img [insert] */	sIR("BODY > DIV#container > TABLE#layout > TBODY > TR:first-child > TD#header > DIV > DIV.divider {height:65px !important; background:transparent url('"+gL+"') no-repeat scroll 0 center !important;}");
	...
	// iGoogle
	  ...
	  /* search btn spacing */	sIR(".gseain INPUT[type='submit'],INPUT[name='btnG'],INPUT[name='btnI'] {margin-top:5px; margin-right:30px; margin-left:30px;}");
	}
	...
	// Web Search  (inc. Google Encrypted Home)
		...
		/* Home logo [hide] */	sIR("BODY > CENTER > DIV#lga > IMG {visibility:hidden;}");
		/* Home logo [insrt] */	sIR("BODY > CENTER > DIV#lga {padding-top:20px; background:transparent url('"+gHpL+"') no-repeat scroll center top !important;}");
		/* logo [remove] */	sIR("BODY > DIV#cnt > DIV#sfcnt > FORM#tsf > DIV > DIV:first-child > A:first-child > IMG[style='padding-top: 10px;']:first-child {display:none;}");
		/* logo [insert] */	sIR("BODY > DIV#cnt > DIV#sfcnt > FORM#tsf > DIV > DIV:first-child {width:150px; height:65px; background:transparent url('"+gL+"') no-repeat scroll 0 center;}");
	...
	// Directory
	else if(iO(lH,"directory.google.")>-1||iO(lH,".google."+Gtld+"/Top/")>-1){
		/* applyGlobals */	Ge();
	...
	// Support
		...
		/* R modules header */	sIR("TD.right_column > DIV.module > H2 {position:relative; bottom:12px; left:0; padding:2px 0 0 10px; background-color:#555; border:0 none !important; color:#fff; "+bS('border-radius-topright')+":14px; "+bS('border-radius-topleft')+":14px;}");
	...
	// News
		...
		/* search btn pos */	sIR(".background #page-header .goog-inline-block {display:inline; padding-left:5px;}");
	...
	else if(iO(lH,".google.")>-1&&iO(lH,"/advanced_image_search")>-1){
		/* applyGlobals */	Ge();
	...
	// Images
	else if(iO(lH,"images.google.")>-1||iO(lH,".google."+Gtld+"/images")>-1||iO(lH,".google."+Gtld+"/imghp")>-1){
		/* applyGlobals */	Ge();

		/* home logo [insrt] */	sIR("BODY > CENTER > DIV#lga {width:281px !important; height:131px !important; background:transparent url('"+gHpL+"') no-repeat scroll top center !important;}");
		/* logo img [remove] */	sIR("DIV#hife-hd > A > IMG[width='72px'],BODY > DIV#container > DIV#header > IMG#logo {display:none;}");
		/* logo img [insert] */	sIR("BODY > DIV#container > DIV#header {height:55px !important; background:transparent url('"+gL+"') no-repeat scroll 0 !important; font-size:0;}");
		/* logo innerTxtHide */	sIR("FORM#tsf > DIV > DIV:first-child > H1:first-child > A#logo {font-size:0 !important;}");
	...
	// Images Zoom-[R]Sidebar
	else if(iO(lH,".google."+Gtld+"/imgres?imgurl=")>-1){
		/* applyGlobals */	Ge();
		...
		/* R-s logo [hide] */	sIR("BODY > DIV#il > DIV#il_m:first-child > DIV[style='padding: 12px;']:first-child > A > IMG {visibility:hidden;}");
		/* R-s logo [insert] */	sIR("BODY > DIV#il > DIV#il_m:first-child > DIV[style='padding: 12px;']:first-child {background:transparent url('"+gL+"') no-repeat scroll 7px 0 !important;}");
	...
	// Videos
	else if(iO(lH,"video.google.")>-1){
		/* home logo [hide] */	sIR("BODY > CENTER > IMG[width='276'] {visibility:hidden;}");
		/* home logo [insrt] */	sIR("BODY > CENTER {background:transparent url('"+gHpL+"') no-repeat scroll center 30px !important;}");
		/* h.lowertrLogoHdr */	sIR("BODY > CENTER > DIV.container {background-color:#000;}");

		/* logo img [insert] */	sIR("BODY > DIV#videoheader > TABLE.table-header > TBODY > TR:first-child > TD[valign='top']:first-child {width:150px !important; height:55px !important; background:transparent url('"+gL+"') no-repeat scroll 0 !important; font-size:0;}");
	...
	// Maps
	else if(iO(lH,"maps.google.")>-1){
		/* L-panel bg */	sIR("#page > #panel {background-color:transparent;}");
		...
		/* place page bg */	sIR("DIV#page > DIV#wpanel {background-color:inherit !important;}");
		...
		/* headers / boxes*/	sIR(".bar,.ddwpt,.altroute_current,.altroute_hover,.dir_altroute_hover,#panel .selected,#panel .dir-stephover,.db,.sdb,.db .w,.sdb .w,.rmi-dialog-title {background-color:#222 !important; color:#fff !important; "+bS('radiusAll')+":14px;}");
	...
	// Docs
	else if(iO(lH,"//docs.google.")>-1||iO(lH,".google."+Gtld+"/google-d-s/")>-1){
		/* applyGlobals */	Ge();

		/* txt fix-override */	if(iO(lH,".google."+Gtld+"/google-d-s/")==-1)sIR("HTML,BODY {color:inherit !important;}");
		...
		/* logo [insert] */	sIR("BODY#editPage > TABLE#encloser > TBODY > TR#navigation > TD > TABLE[width='100%'] > TBODY > TR[style='height: 40px;'] > TD[style='padding-left: 2px;'],BODY > TABLE > TBODY > TR:first-child > TD#logo,BODY > DIV.g-doc:first-child > DIV.header:first-child {width:150px !important; height:55px !important; background:transparent url('"+gL+"') no-repeat scroll 0% !important; font-size:0;}");
	...
	// Product Search / Shopping Home
	else if(iO(lH,".google.")>-1&&iO(lH,"/prdhp?")>-1){
		/* logo img [hide] */	sIR("BODY > DIV#hp-cont > H1#hp-logo > IMG,BODY DIV#hp-cont > H1#hp-logo > IMG {visibility:hidden;}");
		/* home logo [insrt] */	sIR("BODY > DIV#hp-cont > H1#hp-logo,BODY DIV#hp-cont > H1#hp-logo > IMG {background:transparent url('"+gHpL+"') no-repeat scroll center 20px !important;}");
		/* srch input btn bg*/	sIR("TABLE#search-input > TBODY > TR > TD > DIV.srchButtonRightShadow,TABLE#search-input > TBODY > TR > TD > DIV.srchButtonRightShadow > DIV.srchButtonBorder {padding-left:1em; background-color:transparent; border:0 none transparent;}");
		/* footer */		if(uHideFooters)sIR("BODY > DIV#hp-cont > P.copyright {display:none;}");
	}
	// Product Search / Shopping Results
	else if(iO(lH,".google."+Gtld+"/products")>-1){
		/* applyGlobals */	Ge();
		/* home logo [insrt] */	sIR("BODY > DIV#hp-cont > H1#hp-logo,BODY DIV#hp-cont > H1#hp-logo {background:transparent url('"+gHpL+"') no-repeat scroll center 0 !important;}");
		...
		/* logo img [remove] */	sIR("BODY > DIV#pp-header > FORM[name='f'] > TABLE:first-child > TBODY > TR:first-child > TD:first-child > A#pp-logo > IMG,BODY DIV#srp-header > FORM[name='f'] > TABLE > TBODY > TR > TD > A#srp-logo > IMG {display:none;}");
		/* logo img [insert] */	sIR("BODY > TABLE[width='100%']:first-child > TBODY > TR:first-child > TD[width='1%']:first-child,BODY > DIV#pp-header > FORM[name='f'] > TABLE:first-child > TBODY > TR:first-child > TD:first-child {width:150px !important; height:55px !important; background:transparent url('"+gL+"') no-repeat scroll 0 !important; font-size:0;}");
		/* headers */		sIR(".productsubheader,DIV#pp-cont H2 {padding-left:0.5em; background-color:#333 !important; border:0 none !important; color:#fff; "+bS('radiusAll')+":14px;}");
	...
	else if(iO(lH,".google.")>-1&&iO(lH,"/advanced_product_search")>-1){
		/* logo img [hide] */	sIR("A#advd-logo > IMG {display:none;}");
		/* header */		sIR("DIV#advd-search-header H1 {margin-top:0.8em; padding-left:0.5em; border:0 none !important; background-color:#333 !important; color:#fff !important; "+bS('radiusAll')+":14px;}");
		/* adv search box */	sIR("BODY > FORM > DIV.as-table-cont,BODY > FORM > DIV.as-table-cont TD {border:0 none; color:#999 !important;}");
	...
	// Picasa Web Albums
		...
		/* search header bar */	sIR(".lhcl_contextbar {width:99%; margin-left:5px; margin-right:5px; background:#333 none; border:0 none; "+bS('radiusAll')+":14px;}");
		/* searchR. help box */	sIR(".lhcl_search_results_help {background:#151515 none; border:0 none; color:#999; "+bS('radiusAll')+":14px;}");
		...
		/* search hdrBar bg */	sIR(".lhcl_contextbar,.gphoto-context-box {border:0 none; background-color:#333; color:#fff !important; "+bS('radiusAll')+":14px;}");
		/* search optionsBar */	sIR(".lhcl_googlephotos_body .lhcl_toolbar {border:0 none !important; background-color:#000 !important;}");
		/* searchResultPgNms */	sIR("TABLE#lhid_pager DIV {background-image:none;}");
	...
	// Translate
	 ...
	 if(iO(lH,"/toolkit/")>-1){ //T.Toolkit
		...
		/* logo img [remove] */	sIR("BODY > DIV#whole > DIV[style='margin: 10px 0pt 5px;'] > A > IMG[height='40'],BODY > DIV[style='margin: 10px 0pt 5px;'] > A > IMG[height='40'] {display:none;}");
		/* logo img [hide] */	sIR("BODY > DIV#gt-c > H1#gt-logo > A > IMG[height='40'] {visibility:hidden;}");
		/* logo img [insert] */	sIR("BODY > DIV#gt-c > H1#gt-logo {width:160px !important; height:55px !important; background:transparent url('"+gL+"') no-repeat scroll top left !important; font-size:0;}");
		...
		/* headers */		sIR("BODY > DIV#whole H1,BODY > DIV#whole H2,BODY > DIV#content H1,BODY[marginheight='3'][topmargin='3'] > H1,BODY > DIV#whole DIV#middle_body DIV#autotrans,BODY > DIV#whole DIV#middle_body DIV#dict > P#dict_head,#gt-promos > H2 {background-color:#333 !important; color:#fff; padding-left:0.7em; "+bS('radiusAll')+":14px;}");
		...
		/* original txt */	sIR(".goog-te-balloon-text,.goog-te-balloon B {color:#ccc;}");
	...
	// Profiles
		...
		/* headers */		sIR(".profile-editor .profile_section_header,DIV.CSS_PROFILES_UPDATE_BUTTONS {padding-left:0.5em; background-color:#333; border:0 none; "+bS('radiusAll')+":14px;}");
	...
	// Groups
		...
		/* logo img [hide] */	sIR("BODY > TABLE[width='100%'] > TBODY > TR[valign='bottom'] > TD[valign='top'] > A[href='/'] > IMG[width='185'],BODY > TABLE#title-t > TBODY > TR > TD.tc > A#logo > IMG,BODY > TABLE#sft.tb > TBODY > TR:first-child > TD.tc > A#logo > IMG[width='185'] {visibility:hidden;}");
		...
		/* header spacers */	sIR("TD[bgcolor='#c3d9ff'],TD[bgcolor='#dce9ff'] {background-color:#000;}");
	...
	// Books
		...
		/* logo img [insert] */	sIR("BODY > FORM[action='/books'] > TABLE > TBODY > TR > TD[width='1%'],BODY > DIV.header,BODY > DIV#top_search_bar,DIV#gb-top-search-box TD.logo,#gb-top-search-box > TABLE:first-child > TBODY > TR > TD:first-child {width:150px !important; height:50px !important; background:transparent url('"+gL+"') no-repeat scroll 0 !important; font-size:0;}");
	...
	// Scholar
		...
		/* logo img [hide] */	sIR("BODY > CENTER > TABLE:first-child > TBODY > TR:first-child > TD:first-child > IMG[width='276'],BODY > FORM > TABLE[width='99%'][cellspacing='2'] > TBODY > TR > TD[width='1%'] > A > IMG[width='189'],BODY > FORM[name='prefform'] > CENTER > TABLE > TBODY > TR > TD[width='1%'] > A > IMG,BODY > FORM > DIV#scife_hdr > DIV[width='189'] > A > IMG[width='189'],BODY > TABLE[width='100%'][style='clear: both; margin: 7px 3px;'] > TBODY > TR > TD[valign='top'] > A > IMG {visibility:hidden;}");
		/* logo img [insert] */	sIR("BODY > DIV.g-doc:first-child > DIV.header,BODY > FORM > DIV#scife_hdr > DIV[width='189'],BODY > TABLE[width='100%'][style='clear: both; margin: 7px 3px;'] > TBODY > TR > TD[valign='top'] {width:150px !important; height:55px !important; background:transparent url('"+gL+"') no-repeat scroll 0 !important; font-size:0;}");
	...
	// Blogs
	 ...
	 if(iO(lH,"/advanced_blog_search")>-1){ //Advanced Search
		/* applyGlobals */	Ge();
		...
		/* logo img [remove] */	sIR("BODY > DIV > TABLE#srch_box_t > TBODY > TR > TD:first-child > A > IMG[height='40'],BODY > DIV#h > TABLE:first-child > TBODY > TR > TD:first-child > A > IMG {display:none;}");
		/* logo img [hide] */	sIR("BODY > DIV#h > TABLE:first-child > TBODY > TR > TD:first-child > A > IMG,BODY > CENTER > IMG[width='293'][height='40'] {visibility:hidden;}");
		/* logo img [insert] */	sIR("BODY > CENTER > TABLE > TBODY > TR[height='4'] > TD {position:absolute; top:30px; width:150px; height:55px; background:transparent url('"+gL+"') no-repeat scroll 0 0 !important; font-size:0;}");
	...
	// Power Meter
	else if(iO(lH,".google."+Gtld+"/powermeter/")>-1){
		/* applyGlobals */	Ge();

		/* logo img [remove] */	sIR("BODY > H1 > A > IMG {display:none;}");
		/* logo img [insert] */	sIR("BODY > H1 {width:150px !important; height:55px !important; background:transparent url('"+gL+"') no-repeat scroll 0 !important; font-size:0;}");
	...
	// Gmail
	 ...
	 if(iO(lH,"/mail/help/")>-1&&(iO(lH,".html")>-1||iO(lH,"/tasks/")>-1)){ //supportingPages
		...
		/* view type headers */		sIR("TABLE.bn > TBODY> TR > TD#bm {border:0 none; background-color:#181818; "+bS('radiusAll')+":14px;}");
		/* logo img */			sIR("BODY[bgcolor='#ffffff'] > TABLE[width='100%'] > TBODY > TR:first-child > TD[width='143'] > H1 > A > IMG {display:none;}");
		/* menu selected */		sIR("BODY > TABLE > TBODY > TR > TD > TABLE[width='100%'].m > TBODY > TR > TD[bgcolor='#c3d9ff'],BODY > TABLE > TBODY > TR > TD > TABLE[width='100%'].m > TBODY > TR > TD[bgcolor='#fad163'] {background-color:#333; "+bS('border-radius-topleft')+":14px; "+bS('border-radius-bottomleft')+":14px;}");
		/* menu selected txt */		sIR("BODY > TABLE > TBODY > TR > TD > TABLE[width='100%'].m > TBODY > TR > TD[bgcolor='#c3d9ff'] A,BODY > TABLE > TBODY > TR > TD > TABLE[width='100%'].m > TBODY > TR > TD[bgcolor='#fad163'] A {color:#fff !important;}");
		/* upper alert msg box */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD > TABLE[cellspacing='4'][align='center'] > TBODY > TR:first-child > TD:first-child {"+bS('radiusAll')+":14px;}");
		/* upper alert msg box txt */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD > TABLE[cellspacing='4'][align='center'] > TBODY > TR:first-child > TD:first-child > B {color:#000 !important;}");
		/* search options bgs */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#74d982'],BODY > TABLE[width='100%'] > TBODY > TR > TD > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#b5edbc'],BODY > TABLE[width='100%'] > TBODY > TR > TD > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#b5edbc'] > TABLE[bgcolor='#74d982'] {background-color:#000 !important;}");
		...
		/* msg header */		sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD > TABLE[width='100%'] > TBODY > TR > TD > TABLE[width='100%'][bgcolor='#e0ecff'] {background-color:#000;}");
		...
		/* msg lowerReplyBox */		sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD > TABLE[width='100%'] > TBODY > TR > TD TABLE[width='100%'].qr TD {background-color:#000; color:#999 !important;}");
		/* msg lowerReplyBox logoFix */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD > TABLE[width='100%'] > TBODY > TR > TD TABLE[width='100%'].qr > TBODY > TR > TD > TABLE > TBODY > TR > TD[colspan='2'] > TABLE[width='100%'] > TBODY > TR > TD[width='1%'] {background-image:none !important;}");
		/* compose tbl */		sIR("FORM[name='f'] > TABLE.compose {background-color:#000;}");
		/* compose tbl logo fix */	sIR("FORM[name='f'] > TABLE.compose > TBODY > TR:first-child > TD[width='1%']:first-child {width:inherit !important; height:inherit !important; font-size:0.8em; background-image:none !important;}");
		/* contacts list header */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD > TABLE[bgcolor='#fad163'] > TBODY > TR:first-child > TD:first-child > DIV.hp > DIV.bg {background-color:#333;}");
		/* contacts list bg */		sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD > TABLE[bgcolor='#ffffff'].th,BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#fff7d7'] {background-color:#000;}");
		/* contacts list tbl txt */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD > TABLE[bgcolor='#ffffff'].th > TBODY > TR > TD {color:#ccc !important;}");
		/* settings selected tab */	sIR("BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD > TABLE[bgcolor='#ffffff'].th,BODY > TABLE[width='100%'] > TBODY > TR > TD[valign='top'] > TABLE[width='100%'] > TBODY > TR > TD[bgcolor='#fff7d7'] DIV.nav > UL > LI.on {background-color:#333; color:#fff;}");
		/* header txt */		sIR("BODY > TABLE[width='100%'] > TBODY > TR TD[bgcolor='#fff7d7'] > TABLE[bgcolor='#fad163']:first-child H2 {color:#fff;}");
		...
		/* filters header */		sIR("BODY > TABLE[width='100%'] > TBODY > TR TD[bgcolor='#fff7d7'] > TABLE[bgcolor='#fad163']:first-child {padding-left:0.5em; background-color:#000;}");
		/* filters tab selected */	sIR("BODY > TABLE[width='100%'] > TBODY > TR TD[bgcolor='#fff7d7'] > TABLE[bgcolor='#fad163']:first-child DIV.nav > UL > LI.on {background-color:#333; color:#fff;}");
		/* page txt */			sIR("BODY > TABLE > TBODY > TR > TD > TABLE.ft TD,BODY > TABLE > TBODY > TR > TD > TABLE.ft TD DIV,BODY > TABLE > TBODY > TR > TD > TABLE > TBODY > TR > TD[bgcolor='#fff7d7'] > DIV.prf TD,BODY > TABLE > TBODY > TR > TD > TABLE > TBODY > TR > TD[bgcolor='#fff7d7'] > DIV.prf DIV {color:#999 !important;}");
	...
	// Apps
	else if(iO(lH,".google."+Gtld+"/apps/")>-1){}
	...
	// Alerts
		...
		/* logo img [insert] */	sIR("BODY TABLE:first-child > TBODY > TR > TD[width='150'][rowspan='3'],BODY > FORM > TABLE[style='margin: 2em 1em;'] > TBODY > TR:first-child > TD:first-child > DIV.logo-div {width:150px !important; height:55px !important; background:transparent url('"+gL+"') no-repeat scroll top left !important; font-size:0;}");
	...
	// Instant (info-pg)
	else if(iO(lH,".google."+Gtld+"/instant/")>-1){
		/* applyGlobals */	Ge();

		/* logo img [hide] */	sIR("BODY > DIV#g-doc > DIV.header > A > IMG {display:none;}");
		/* logo img [insert] */	sIR("BODY > DIV#g-doc > DIV.header {padding-left:160px; height:55px !important; background:transparent url('"+gL+"') no-repeat scroll top left !important;}");
	...
	// Answers
		...
		/* logo img [remove] */	sIR("TABLE.top > TBODY > TR:first-child > TD:first-child > IMG[src='answers/answers-logo-sm.gif'],BODY[bgcolor='#ffffff'] > TABLE[width='100%'][cellpadding='2']:first-child > TBODY > TR:first-child > TD[width='1%']:first-child > A > IMG[width='143'] {display:none;}");
	...
	// World Cup
	else if(iO(lH,".google."+Gtld+"/worldcup")>-1){
		/* applyGlobals */	Ge();

		/* logo img [remove] */	sIR("BODY > H1 > A[href='/'] > IMG[alt='Google'],BODY > H1 > A[href='/'] > IMG[alt='iGoogle'],BODY > H1 > A[href='/chrome'] > IMG[alt='Google Chrome'] {display:none;}");
		/* logo img [insert] */	sIR("BODY > H1 {height:50px !important; padding-left:160px; background:transparent url('"+gL+"') no-repeat scroll 0 !important; color:#fff;}");
	...
	// Firefox Start
	else if(iO(lH,".google."+Gtld+"/firefox")>-1){
		/* applyGlobals */	Ge();

		/* search outer */	sIR("FORM[name='f'] > TABLE#frame {margin-top:50px; padding-left:20px; background-color:#fff; "+bS('radiusAll')+":14px;}");
		/* search inner */	sIR("FORM[name='f'] > TABLE#frame > TBODY > TR > TD > TABLE[width='100%'][cellspacing='0'][cellpadding='0'][border='0'] > TBODY > TR > TD[width='100%'] > TABLE[cellspacing='0'][cellpadding='0'] {margin:20px; padding: 0 13px 13px 20px; background-color:#000; "+bS('radiusAll')+":14px;}");
		...
		/* orange search btn */	sIR("FORM[name='f'] > TABLE#frame > TBODY > TR > TD > TABLE[width='100%'][cellspacing='0'][cellpadding='0'][border='0'] > TBODY > TR > TD[width='100%'] > TABLE[cellspacing='0'][cellpadding='0'] > TBODY > TR > TD INPUT[type='submit']:hover {background-color:#f60;}");
...
if(isiG){
 ...
 if(iO(uA,"chrome")==-1)iGheaderInsert.setAttribute('style','float:left; position:relative; top:-1.6em;');
...
function configureScript(e){
	...
	function createLayers(){
		...
		$("gsconf_uLogoLuriCustom").addEventListener("focus",cfgLlF,false);
		$("gsconf_uLogoLuriCustom").addEventListener("blur",cfgLlB,false);
		...
		$("gsconf_uLogoSuriCustom").addEventListener("focus",cfgLsF,false);
		$("gsconf_uLogoSuriCustom").addEventListener("blur",cfgLsB,false);
	...
	function _cfgC(w,s,c,b){
		if(typeof b=="boolean"){
			...
			if($("gsconf_uLogoLuriCustom").value=="none")$("gsconf_uLogoLuriCustom").value="";
			else if($("gsconf_uLogoSuriCustom").value=="none")$("gsconf_uLogoSuriCustom").value="";
	...
	function saveConfiguration(evt){
		...
		GM_setValue("uLogoLuri",$("gsconf_uLogoLuriCustom").value);
		GM_setValue("uLogoSuri",$("gsconf_uLogoSuriCustom").value);

...
// General Google Page
	...
	/* submit btns */		"INPUT[type='submit'],BUTTON,BUTTON[type='submit'],INPUT[value='Cancel'],INPUT[value='Save'],INPUT#stxemailsend,INPUT[value='Discard'],INPUT[value='Download'],INPUT[value='Add it now'],INPUT[type='button'][value='Save changes'],INPUT[type='reset'][value='Clear All'],INPUT[type='reset'][value='Reset'],INPUT[type='button'][value='Done'],INPUT[type='button'][value='Copy'],INPUT[type='button'][value='Move'],INPUT[type='button'][value='Delete'],INPUT[type='button'][value='Compare'],INPUT[type='button'][value='Check for Updates'],DIV.gac_bt > INPUT {background-color:#333; background:"+bS('gradLinear')+"0% 0%,0% 100%,from(#555),to(#000)) !important; border:solid 1px #ccc; "+bS('radiusAll')+":14px; color:#fff !important; cursor:pointer;}" +
...
function _gL(W){if(uHideLogos){return ""}else{
	if(W=="H")return "http://66.104.77.10/g/gHpL.4.jpg";
	else return "http://66.104.77.10/g/gL.4.png";
}}
